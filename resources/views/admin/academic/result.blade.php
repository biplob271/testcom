            ...
            <div class="modal-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <select name="result_class" id="" class="form-control" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-sm" name="exam_name" value="" required /> 
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-sm" name="{{$item->subject_name}}" value="" required /> 
                    </div>
                </div>
                @endforeach
