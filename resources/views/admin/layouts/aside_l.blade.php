<div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-md xnav-legacy nav-compact nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          @if (Auth::user()->user_type == 'admin')
              @include('admin.admin-menu')
          @endif
          @include('admin.admin-menu')
          @if (Auth::user()->user_type == 'merchant')
              @include('merchant.merchant-menu')
          @endif
